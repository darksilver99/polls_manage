                ...
                child: Text(
                  () {
                    if (widget!.currentStep == 1) {
                      ...
                      return 'กรุณาเลือกจำนวนผู้ตอบที่ต้องการรองรับจากตัวเลือกที่กำหนด ระบบจะช่วยจัดการการตอบคำถามให้อยู่ในขอบเขตที่เลือก เพื่อให้สามารถสรุปผลได้อย่างมีประสิทธิภาพ';
                    }
                  }(),
                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                        fontFamily: 'Kanit',
