...
import 'type_form_view_model.dart';
...
class _TypeFormViewWidgetState extends State<TypeFormViewWidget> {
  late TypeFormViewModel _model;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Builder(
                          builder: (context) {
                            final optionListView = _model.optionList.toList();

                            return Column(
                              mainAxisSize: MainAxisSize.max,
                              children: List.generate(optionListView.length,
                                  (optionListViewIndex) {
                                final optionListViewItem =
                                    optionListView[optionListViewIndex];
                                return Row(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                                    Expanded(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText: 'ระบุคำตอบ เช่น เห็นด้วย',
                      ...
                      Builder(
                        builder: (context) => FFButtonWidget(
                          onPressed: () async {
                            if (_model.optionList.isNotEmpty) {
                              Navigator.pop(context, _model.optionList);
                            } else {
                              await showDialog(
                                context: context,
