      ...
      body: SafeArea(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(32.0, 64.0, 32.0, 16.0),
                child: Row(
                  mainAxisSize: MainAxisSize.max,
                        ...
                        builder: (context) => InkWell(
                          ...
                          onTap: () async {
                            ...
                            if (_model.qrCode != null && _model.qrCode != '') {
                              _model.pollResult =
                                  await PollListRecord.getDocumentOnce(functions
                                      .getPollDocument(_model.qrCode)!);
                              if (_model.pollResult != null) {
                                context.pushNamed(
                                  ...
                                  extra: <String, dynamic>{
                                    'pollDocument': _model.pollResult,
                                  },
                                );
                              } else {
                                await showDialog(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: Text(
                                            'สแกนเพื่อทำแบบสำรวจ,ความเห็น,ทดสอบ',
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            context.pushNamed('PollListPage');
                          },
                          child: Material(
                            color: Colors.transparent,
                            elevation: 3.0,
